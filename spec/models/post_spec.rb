...
RSpec.describe Post, type: :model do
  ...
  describe 'スコープ' do
    describe 'body_contain' do
      let!(:post) { create(:post, body: 'hello world') } # hello worldと書いた投稿を作成
      subject { Post.body_contain('hello') } # Postモデルに定義したbody_containメソッドでhelloという文字列を検索
      it { is_expected.to include post } # 検索対象に作成した投稿が含まれていればテストが通る
    end
  end
end
